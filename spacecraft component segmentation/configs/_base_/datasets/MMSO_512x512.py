...
data_root = 'data/TriM-SOD'  # 数据的根路径
...
train_dataloader = dict(  # 训练数据加载器(dataloader)的配置
    ...
    dataset=dict(  # 训练数据集配置
        ...
        data_prefix=dict(
            img_path='images/train', seg_map_path='annotations/train'),  # 训练数据的前缀
...
val_dataloader = dict(
    ...
    dataset=dict(  # 测试数据集配置
        ...
        data_root=data_root,  # 数据集的根目录
        data_prefix=dict(
            img_path='images/val', seg_map_path='annotations/val'),  # 测试数据的前缀
